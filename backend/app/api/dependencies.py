...
from app.services import CardService, UserService, CollectionService, TrainService, StorageService, NotificationService
...
__all__ = [
    ...
    "UserServiceDep", "NotificationServiceDep", "IntListBody"
]
