...
async def read_card_collections(user_id: UserIdDep, card_id: int, card_service: CardServiceDep):
    return await card_service.get_card_collections(user_id, card_id)


@router.get("/{card_id}/files", response_model=list[FileMeta])
async def read_card_files(user_id: UserIdDep, card_id: int, card_service: CardServiceDep):
...
async def delete_card(user_id: UserIdDep, card_id: int, card_service: CardServiceDep):
