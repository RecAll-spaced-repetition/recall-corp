...
from .dependencies import StorageServiceDep, UserIdDep, UserIdSoftDep
...
async def add_file(
    user_id: UserIdDep, storage_service: StorageServiceDep, file: UploadFile
) -> FileMeta:
...
async def get_file_meta(
    file_id: int, user_id: UserIdSoftDep, storage_service: StorageServiceDep
) -> FileMeta:
...
async def get_file_cards(
    file_id: int, user_id: UserIdDep, storage_service: StorageServiceDep
) -> list[int]:
...
async def delete_file(file_id: int, user_id: UserIdDep, storage_service: StorageServiceDep):
